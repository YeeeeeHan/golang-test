...
const UsernameFileTest = "..../cmd/db/test/username_test.txt"
const BalanceFileTest = "../../cmd/db/test/balance_test.db"
const PasswordFileTest = "../../cmd/db/test/password_test.db"
